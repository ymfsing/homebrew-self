cask "ttf-lxgw-wenkai-mono-light" do
  version "1.111"
  sha256 :no_check

  url "https://github.com/lxgw/LxgwWenKai/releases/download/v#{version}/LXGWWenKaiMono-Light.ttf"
  name "LXGW WenKai Mono Light"
